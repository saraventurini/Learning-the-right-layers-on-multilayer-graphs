...
function state_of_art_methods_real()
    datasets_list = ["3sources","aucs","BBCSport2view_544","BBC4view_685","WikipediaArticles","citeseer","cora","dkpol","UCI_mfeat"];
    perc_list = [15,10,5,1]; 
...
function run(dataset,perc)
    ...
    %SGMI
    acc_list = SGMI(A_list,Y_list,labels_list,sample1,K,N,C,dataset,perc);
    methods_mean(1,1) = mean(acc_list);
    methods_mean(1,2) = std(acc_list);
    
    %SMACD
    acc_list = SMACD(A_list,Y_list,labels_list,sample1,K,N,C,dataset,perc);
    methods_mean(1,3) = mean(acc_list);
    methods_mean(1,4) = std(acc_list);
    
    %GMM
    acc_list = GMM(A_list,Y_list,labels_list,sample1,K,N,C,dataset,perc);
    ...
    for k=1:2
        ...
        sample1 = 1; %number sample random matrices
        ...
        %SGMI
        acc_list = SGMI_noisy(A_list,Y_list,labels_list,sample1,sample2,K,N,C,dataset,k,perc);
        methods_mean(k+1,1) = mean(acc_list);
        methods_mean(k+1,2) = std(acc_list); %std(mean(acc_list));

        %SMACD
        acc_list = SMACD_noisy(A_list,Y_list,labels_list,sample1,sample2,K,N,C,dataset,k,perc);
        methods_mean(k+1,3) = mean(acc_list);
        methods_mean(k+1,4) = std(acc_list);
        
        %GMM
        acc_list = GMM_noisy(A_list,Y_list,labels_list,sample1,sample2,K,N,C,dataset,k,perc);
        methods_mean(k+1,5) = mean(acc_list);
        methods_mean(k+1,6) = std(acc_list);
    end 
    

    writematrix(methods_mean,"Results_Real\"+dataset+"\Matlab_acc_"+dataset+"_knn5_perc"+perc+"_lam1_.csv")
end

function acc_list = SGMI(A_list,Y_list,labels_list,sample1,K,N,C,dataset,perc)
    ...
    %save
    save("Results_Real\"+dataset+"\SGMI\Matlab_"+dataset+"_knn5_perc"+perc+"_lam1.mat", 'acc_list')

end

function acc_list = GMM(A_list,Y_list,labels_list,sample1,K,N,C,dataset,perc)
    addpath(genpath('Utils'))
    ...
    %save
    save("Results_Real\"+dataset+"\GMM\Matlab_"+dataset+"_knn5_perc"+perc+"_lam1.mat", 'acc_list')
end

function acc_list = SMACD(A_list,Y_list,labels_list,sample1,K,N,C,dataset,perc)
    addpath(genpath('Utils'))
    ...
    %save
    save("Results_Real\"+dataset+"\SMACD\Matlab_"+dataset+"_knn5_perc"+perc+"_lam1.mat", 'acc_list')
end



function acc_list = SGMI_noisy(A_list,Y_list,labels_list,sample1,sample2,K,N,C,dataset,kk,perc)
    ...
    %save
    save("Results_Real\"+dataset+"\SGMI\Matlab_"+dataset+"_knn5_perc"+perc+"_lam1_Knoisy"+kk+".mat", 'acc_list')

end

function acc_list = GMM_noisy(A_list,Y_list,labels_list,sample1,sample2,K,N,C,dataset,kk,perc)
    addpath(genpath('Utils'))
    addpath(genpath('GMM\PM_SSL-master\'))
    ...
    %save
    save("Results_Real\"+dataset+"\GMM\Matlab_"+dataset+"_knn5_perc"+perc+"_lam1_Knoisy"+kk+".mat", 'acc_list')
end

function acc_list = SMACD_noisy(A_list,Y_list,labels_list,sample1,sample2,K,N,C,dataset,kk,perc)
    addpath(genpath('Utils'))
    addpath(genpath('SMACD\SMACD-master\SMACD-master\'))
    ...
    %save
    save("Results_Real\"+dataset+"\SMACD\Matlab_"+dataset+"_knn5_perc"+perc+"_lam1_Knoisy"+kk+".mat", 'acc_list')
end
